...
%\includeonlyframes{titleframe,plan,simple}
...
\title[Engineering Physics]{Engineering Physics (2025) \\ Course code
	25PY101 \\ Module 2 Unit 2: Optoelectronics}
...
\begin{document}
	...
	%
	\ifshowhidden
	\input{parts/unit_4/05_photodiode}
	\fi
	%
	\section{Direct and indirect band gap semiconductors}
	%
	\ifshowhidden
	\input{parts/unit_4/03_direct_indirect_bandgap_semiconductors}
	\fi
	%
	\section{Light Emitting Diode}
	%
	\ifshowhidden
	\input{parts/unit_4/04_led}
	\fi
	%
	\section{Tunneling diode}
	%
	\ifshowhidden
	\input{parts/unit_4/06_tunneling_diode}
	\fi
\end{document}